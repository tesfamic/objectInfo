...
(cl:defclass <objectPosArray> (roslisp-msg-protocol:ros-message)
  ((position
    :reader position
    :initarg :position
    :type (cl:vector objectLocation0-msg:objectPos)
   :initform (cl:make-array 0 :element-type 'objectLocation0-msg:objectPos :initial-element (cl:make-instance 'objectLocation0-msg:objectPos))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <objectPosArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'objectPosArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name objectLocation0-msg:<objectPosArray> is deprecated: use objectLocation0-msg:objectPosArray instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <objectPosArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader objectLocation0-msg:position-val is deprecated.  Use objectLocation0-msg:position instead.")
  (position m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <objectPosArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'position)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'objectLocation0-msg:objectPos))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<objectPosArray>)))
  ...
  "objectLocation0/objectPosArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'objectPosArray)))
  "Returns string type for a message object of type 'objectPosArray"
  "objectLocation0/objectPosArray")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<objectPosArray>)))
  ...
  (cl:format cl:nil "objectPos[] position~%~%================================================================================~%MSG: objectLocation0/objectPos~%int16 width~%int16 height~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'objectPosArray)))
  "Returns full string definition for message of type 'objectPosArray"
  (cl:format cl:nil "objectPos[] position~%~%================================================================================~%MSG: objectLocation0/objectPos~%int16 width~%int16 height~%~%~%"))
