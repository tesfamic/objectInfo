...
(cl:defmethod cl:initialize-instance :after ((m <objectPos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'objectPos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name objectLocation0-msg:<objectPos> is deprecated: use objectLocation0-msg:objectPos instead.")))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <objectPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader objectLocation0-msg:width-val is deprecated.  Use objectLocation0-msg:width instead.")
  (width m))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <objectPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader objectLocation0-msg:height-val is deprecated.  Use objectLocation0-msg:height instead.")
  (height m))
