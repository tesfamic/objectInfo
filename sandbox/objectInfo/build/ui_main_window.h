...
**
** Created: Sat Apr 26 20:27:32 2014
...
public:
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        MainWindowDesign->resize(830, 691);
        QIcon icon;
        ...
        gridLayout_2->addWidget(view_logging, 0, 0, 1, 1);
        ...
        verticalLayout_4->addWidget(tab_manager);

        MainWindowDesign->setCentralWidget(centralwidget);
        menubar = new QMenuBar(MainWindowDesign);
        menubar->setObjectName(QString::fromUtf8("menubar"));
        menubar->setGeometry(QRect(0, 0, 830, 20));
        ...
        line_edit_topic->setGeometry(QRect(120, 90, 125, 23));
        ...
        checkbox_use_environment->setGeometry(QRect(130, 272, 187, 21));
        ...
        checkbox_remember_settings->setGeometry(QRect(110, 299, 208, 21));
        ...
        button_connect->setGeometry(QRect(188, 326, 80, 23));
        ...
        label_4->setGeometry(QRect(12, 141, 87, 16));
        labelTiltAngleDisp = new QLabel(groupBox);
        labelTiltAngleDisp->setObjectName(QString::fromUtf8("labelTiltAngleDisp"));
        labelTiltAngleDisp->setGeometry(QRect(140, 140, 121, 21));
        QFont font;
        font.setFamily(QString::fromUtf8("Times New Roman"));
        font.setPointSize(11);
        labelTiltAngleDisp->setFont(font);
        labelTiltAngleDisp->setLayoutDirection(Qt::RightToLeft);
        label_3 = new QLabel(groupBox);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(10, 90, 96, 17));
        label_3->setFrameShape(QFrame::StyledPanel);
        label_3->setFrameShadow(QFrame::Raised);
        label_5 = new QLabel(groupBox);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(20, 180, 151, 20));
        angleInput = new QDoubleSpinBox(groupBox);
        angleInput->setObjectName(QString::fromUtf8("angleInput"));
        angleInput->setGeometry(QRect(200, 180, 101, 24));
        angleInput->setLayoutDirection(Qt::RightToLeft);
        angleInput->setMinimum(-31);
        angleInput->setMaximum(31);
        angleInput->setSingleStep(0.5);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        label_4->setText(QApplication::translate("MainWindowDesign", "tiltAngle value", 0, QApplication::UnicodeUTF8));
        labelTiltAngleDisp->setText(QString());
        label_3->setText(QApplication::translate("MainWindowDesign", "Ros Hostname", 0, QApplication::UnicodeUTF8));
        label_5->setText(QApplication::translate("MainWindowDesign", "Adjust tilt Angle(-31-31)", 0, QApplication::UnicodeUTF8));
